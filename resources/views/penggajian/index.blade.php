...
@section('content')
 <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading"><center><h1><marquee>Pencarian Menurut Pegawai</marquee></h1></center></div>
...
@section('content1')
        ...
        <div class="col-md-15 col-md-offset-0">
            <div class="panel panel-primary">
			    <div class="panel-heading"><center><h1>Data Penggajian</h1></center></div>
	                <div class="panel-body">
